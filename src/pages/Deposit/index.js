...
const Deposit = ({ navigation, route }) => {
    ...
    let { selectedAmount } = route.params || {selectedAmount: 0};
    ...
    const handleRoute = (strategyId, title) => {
        navigation.navigate("InvestmetSelector", { selectedAmount, strategyId, title });
    };
            ...
            <SafeAreaView style={styles.AndriodSafeArea}>
                <ScrollView>
                    <View style={styles.homeContainer}>
                        ...
                        <Text style={styles.title}>Select investment strategy</Text>
